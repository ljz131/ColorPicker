...
class ColorPickerPopup private constructor(builder: Builder) {
    ...
    fun show(parent: View?, observer: ColorPickerObserver?) {
        ...
        val inflater = context.getSystemService(
                Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater ?: return
        @SuppressLint("InflateParams")
        val layout = inflater.inflate(R.layout.top_defaults_view_color_picker_popup, null)
        val colorPickerView: ColorPickerView = layout.findViewById(R.id.colorPickerView)
        popupWindow = PopupWindow(layout, ViewGroup.LayoutParams.WRAP_CONTENT,
